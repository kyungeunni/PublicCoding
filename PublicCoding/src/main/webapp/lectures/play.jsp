						...
						<div class="col-xs-10 col-sm-7 col-md-7">
							<div class="embed-responsive embed-responsive-16by9">
								...
								<iframe class="embed-responsive-item" width="560" height="315"
									src="https://www.youtube.com/embed/${contenturl}"
							...
							<p>
								<c:if test="${sessionScope.id == null }">
									<a href="#" data-toggle="modal" data-target="#login"
										id="asking" class="button large special"> <span
										class="glyphicon glyphicon-play"></span>START COURSE
									</a>
								</c:if>
								<c:if
									test="${gno != confirmCourse.gno && sessionScope.id != null }">
					...
					<div class="col-xs-12 col-sm-12 col-md-12">
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane active" id="home">
								...
								<p>
									강의 내용 : ${ginfo.gintro} <br> 이번 강의는 ${firstCname }편입니다. <br>
									PC로 보실때는 http://www.youtube.com${firstSite } 또는 위의 동영상에서 HD
									동영상을 보시는 것이 좋습니다. <br> 1080p로 설정해서 보시면 글자가 잘 보입니다. 오른쪽 하단
									톱니모양에서 1080p를 선택하세요. <br> 그리고 모바일로 보실 때에는 유튜브 앱으로 보십시오.
									그래야 글자가 잘 보입니다.<br>
								</p>
								<p>PPT 파일, 소스파일은 첨부파일은 http://www.youtube.com${firstSite }을
									참조하세요.</p>
							</div>
									...
									<c:forEach var="i" begin="1" end="4" items="${glist }">
										<div class="col-xs-5 col-sm-4 col-md-3">
											<div class="thumbnail">
												...
												<div class="caption">
													<h5>
														<font color="#000">${i.gname }</font>>
													</h5>
													<p>총 강의수 : ${i.totalcno }강</p>
													<a class="btn btn-mini" href="play.do?gno=${i.gno }">
														강의 알아보기</a>
												</div>
											</div>
										</div>
									...
									<div class="col-xs-10 col-sm-7 col-md-7">
										...
										<table class="table">
											...
											<tr>
												...
												<td><a href="http://www.onlinecompiler.net/"
													target="_blank">http://www.onlinecompiler.net</a></td>
												<td>c/c++, fortran, pascal..</td>
											</tr>
											<tr>
												<td>CodeChef</td>
												<td><a href="https://www.codechef.com/ide"
													target="_blank">https://www.codechef.com/ide</a></td>
