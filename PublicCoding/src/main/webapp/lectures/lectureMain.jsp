										...
										<div class="panel-body">
											...
											<c:forEach var="s" items="${slist }">
												<c:if test="${d.dno == s.dno }">
													<tr>
														<td><a href="scategory.do?sno=${s.sno }">${s.sname }</a></td>
													</tr>
												</c:if>
											</c:forEach>	
											</table>
